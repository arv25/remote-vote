...
grunt.initConfig({
  ...
  lambda_deploy: {
    default: {
      arn: 'arn:aws:lambda:us-east-1:509101369464:function:remote-vote-stag-server-user-org-election-contenders-get',
      options: {
        aliases: 'stag',
    ...
    prod: {
      arn: 'arn:aws:lambda:us-east-1:509101369464:function:remote-vote-prod-server-user-org-election-contenders-get',
      options: {
        aliases: 'prod',
        enableVersioning: true
      }
