...
grunt.initConfig({
  ...
  lambda_deploy: {
    default: {
      arn: 'arn:aws:lambda:us-east-1:509101369464:function:remote-vote-stag-server-register-post',
      options: {
        aliases: 'stag',
    ...
    prod: {
      arn: 'arn:aws:lambda:us-east-1:509101369464:function:remote-vote-prod-server-register-post',
      options: {
        aliases: 'prod',
        enableVersioning: true
      }
